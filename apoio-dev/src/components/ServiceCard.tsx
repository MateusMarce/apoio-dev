    ...
    return (
        <div className="col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4" >
            <div className="food-card">
                ...
                <div className="food-card_content" style={{ cursor: 'pointer' }} onClick={_ => handleClickAddItemCart(servico)}>
                    ...
                    <div className="food-card_bottom-section">
                        ...
                        <div className="row justify-conten-between">
                            ...
                            <div className="food-card_price text-secondary gap-2 d-flex mt-1" title='Valor interno SATC'>
